...
## 💾 커밋 운용
- [x] 기능 단위로 커밋 (feat, fix, refactor 등 **Angular 컨벤션 적용**)
- [x] 커밋 메시지에 구현 기능을 명확히 서술
...
## 🧠 학습 목표
- [x] 큰 함수 → 작은 함수로 분리하여 단일 역할 수행
- [ ] `JUnit5` + `AssertJ` 테스트 코드 작성
- [x] 1주 차 피드백(네이밍, 들여쓰기, 책임 분리 등) 반영
- [x] 객체지향 설계 및 일급 컬렉션 적용 실습
